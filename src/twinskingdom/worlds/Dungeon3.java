...
import  twinskingdom.entities.mobs.enemies.level3.PaladinBoss;
...
/**
  This class implements the third dungeon level, setting their own characters and managing
...
public final class Dungeon3 extends World {
     ...
     * level boss (the paladin). Also player positions are setted. 
     */
    @Override
    protected void setCreatures() {
        ...
        boss = new PaladinBoss(589, 609, new PaladinAssets());
        entities.add(boss);
