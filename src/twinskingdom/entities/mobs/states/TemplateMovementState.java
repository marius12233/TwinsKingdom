...
public abstract class TemplateMovementState extends MovementState {
    ...
    /**
     * *
     * Set the direction and the amount of space that the Entity has to go
     * ahead. Hook method.
     */
    ...
    /**
     * *
     * Set the size and the position of the attack rectangle based on the
     * entity's collision bound rectangle. Hook method.
     *
     * @param ar : the attack rectangle to set dimensions.
     * @param cb : the entity's bound rectangle used in other classes to detect
     * collisions.
     */
