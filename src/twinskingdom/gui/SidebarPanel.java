...
/**
 * This class represents a side panel, where the WeaponPanel and the
 * LevelNamePanel are located.
 */
public class SidebarPanel extends JPanel {
    ...
    /**
     * Sets all the configurations for the SidebarPanel and the relative
     * WeaponPanel.
     *
     * @throws IOException
     */
